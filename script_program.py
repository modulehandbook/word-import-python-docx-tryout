...
if __name__ == '__main__':
    ...
    formatted_output_path = 'output/program_output_formatted.json'
    ...
    print(f"[INFO] Program information extracted successfully! Saved to {output_path}")

    print(f"[INFO] Running format_course_values.py on {output_path} ...")
    subprocess.run(
        [sys.executable, "format_course_values.py", output_path, formatted_output_path],
        check=True
    )